...
LOAD DATA LOCAL INFILE '~/hotel_rooms.csv'
...
LOAD DATA LOCAL INFILE '~/roomcategories.csv'
...
LOAD DATA LOCAL INFILE '~/food_orders.csv'
...
LOAD DATA LOCAL INFILE '~/address_final.csv'
INTO TABLE Address
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
