...
LOAD DATA LOCAL INFILE '/Users/Soapy/Downloads/Data/address.csv'
INTO TABLE Address
...
LOAD DATA LOCAL INFILE '/Users/Soapy/Downloads/Data/customers.csv'
INTO TABLE Customer
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(customerID, firstName, lastName, addressID, loyaltyPts, TelNumber); 

LOAD DATA LOCAL INFILE '/Users/Soapy/Downloads/Data/hotels.csv'
INTO TABLE Hotel
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(hotelNumber, hotelName, addressID);

LOAD DATA LOCAL INFILE '/Users/Soapy/Downloads/Data/room_categories.csv'
...
LOAD DATA LOCAL INFILE '/Users/Soapy/Downloads/Data/hotel_rooms.csv'
...
LOAD DATA LOCAL INFILE '/Users/Soapy/Downloads/Data/bookings.csv'
INTO TABLE Booking
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE '/Users/Soapy/Downloads/Data/employees.csv'
INTO TABLE Employee
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE '/Users/Soapy/Downloads/Data/food_orders.csv'
INTO TABLE FoodOrder
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES
(bookingNumber, price, orderDate);  -- Skip the header row
...
-- Create users
CREATE USER 'read_user' IDENTIFIED BY 'abcd1234';
CREATE USER 'write_user' IDENTIFIED BY 'abcd1234';
...
SET DEFAULT ROLE admin_user TO 'admin';
